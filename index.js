document.addEventListener("DOMContentLoaded", function () {
    ...
    var particleSettings = {
        ...
        move: { enable: true, speed: screenWidth <= 780 ? 3 : 6, direction: 'none', random: false, straight: false, out_mode: 'out', bounce: false, attract: { enable: false, rotateX: 600, rotateY: 1200 } }
        // Add other particle settings as needed
    };
    ...
    particlesJS('particles-js', {
        ...
        retina_detect: true
        // Add other particle configuration options as needed
    });

    // Adjust the height of the particles container
